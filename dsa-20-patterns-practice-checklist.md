# DSA 20 Patterns — Practice Checklist

Source: [DSA was HARD until I Learned these 20 Patterns](https://blog.algomaster.io/p/20-dsa-patterns) by Ashish Pratap Singh
...
- [ ] [Path with Maximum Probability (LeetCode #1514)](https://leetcode.com/problems/path-with-maximum-probability/)
...
- [ ] [Design Add and Search Words Data Structure (LeetCode #211)](https://leetcode.com/problems/design-add-and-search-words-data-structure/)
...
**Total checklist items: 100** (97 unique problems — Trapping Rain Water, Number of Islands, and Top K Frequent Elements each appear under two patterns, matching the article)
